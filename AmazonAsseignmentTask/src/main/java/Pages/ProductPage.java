...
public class ProductPage {
	 ...
	 WebDriver driver;
		...
		@FindBy(xpath ="//div[@class='a-section aok-relative s-image-fixed-height']//img[@data-image-index='7']")
		private WebElement clickOnTheSelectedIphone;
		...
		public void clickOnSelectedIphone() {
			clickOnTheSelectedIphone.click();
		}
		...
		public boolean verifyProductPageDispalyed() {
